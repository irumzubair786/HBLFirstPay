...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JHTAlertController/JHTAlertController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KYDrawerController/KYDrawerController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Kingfisher/Kingfisher.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MBProgressHUD/MBProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MHWebViewController/MHWebViewController.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PinCodeInputView/PinCodeInputView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PinCodeTextField/PinCodeTextField.framework"
