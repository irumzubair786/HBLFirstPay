...
internal final class _Cache<Key: Hashable, Value> {
    ...
    init(costLimit: Int, countLimit: Int) {
        ...
        #if os(iOS) || os(tvOS)
//        NotificationCenter.default.addObserver(self, selector: #selector(removeAll), name: UIApplication.NSNotification.Name.UIApplicationDidReceiveMemoryWarning, object: nil)
//        NotificationCenter.default.addObserver(self, selector: #selector(didEnterBackground), name: UIApplication.NSNotification.Name.UIApplicationDidEnterBackground, object: nil)
        #endif
    }
