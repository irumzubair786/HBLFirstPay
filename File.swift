...
//    var searchedBundleFilters: [String]!
//    
...
//        }
//        if let tempBundleFilters = modelGetBundleDetails?.data[indexSelectedNetwork].bundleFilters {
//            let tempSearched = tempBundleFilters.map { modelBundleFilter in
//                modelBundleFilter.filterName ?? ""
//            }
//            if tempSearched.count > 0 {
//                searchedBundleFilters = tempSearched
//                searchedBundleFilters.insert("All", at: 0)
//            }
//        }
//        else {
//            
//            searchedBundleFilters?.removeAll()
//        }
//
//        
//        tableView.reloadData()
...
//        return CGSize(width: "\(searchedBundleFilters?[indexPath.item] ?? "")".size(withAttributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 17)]).width + 50, height: 50)
//    }
//    
...
//            return 0
//        }
//        return searchedBundleFilters?.count ?? 0
...
//        let filterName = searchedBundleFilters?[indexPath.item] ?? ""
//        
//        cell.labelName.text = "\(filterName)"
//        if selectedCell != nil {
...
//            filterApply(searchingData: [filterName])
//        }
//    }
//}
//
