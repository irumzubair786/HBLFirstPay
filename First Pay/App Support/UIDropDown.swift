...
//            }
    ...
    public var optionsSize: CGFloat = 15.0
...
//    }
    ...
    public var optionsCornerRadius: CGFloat = 2.0 {
        didSet{
    ...
    public var optionsBorderColor: UIColor = .lightGray {
        didSet{
    ...
    fileprivate func setup() {
        ...
        self.isTableShowing = false
        //self.backgroundColor = UIColor.brown
        
        title = UILabel(frame: CGRect(x: 10,
                                      y: 0,
                                      width: (self.frame.width/*-self.frame.height*/),
                                      height: self.frame.height))
        
        title.textAlignment = .left
        optionsTextAlignment = .left
//        if Localize.currentLanguage() == "ar" {
//            title.textAlignment = .right
//            optionsTextAlignment = .right
//        }
//
//        else {
//            title.textAlignment = .left
...
//        self.layer.cornerRadius = cornerRadius
//        self.layer.borderWidth = borderWidth
//      LimitHistoryVC  self.layer.borderColor = borderColor.cgColor
    ...
    fileprivate func showTable() {
        ...
        table.layer.borderWidth = optionsBorderWidth
        table.layer.borderColor = optionsBorderColor.cgColor
        table.rowHeight = 45 //35          //rowHeight ?? table.rowHeight
...
extension UIDropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if rowBackgroundColor == nil {
            cell!.contentView.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)  //rowBackgroundColor
        }
        
        cell!.textLabel!.font = UIFont(name: optionsFont ?? font ?? cell!.textLabel!.font.fontName, size: optionsSize)
        cell!.textLabel!.textColor =  UIColor .darkGray //optionsTextColor ?? tint ?? cell!.textLabel!.textColor
